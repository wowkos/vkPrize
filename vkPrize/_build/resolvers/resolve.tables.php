...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('vkprize_core_path', null,
                    $modx->getOption('core_path') . 'components/vkprize/') . 'model/';
            $modx->addPackage('vkprize', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/vkprize/model/schema/vkprize.mysql.schema.xml';
